...
public class RoundedCornerButton extends JButton {
	...
	private void paintFocusAndRollover(Graphics2D g2) {
		g2.setPaint(new GradientPaint(0, 0, getBackground().darker(), getWidth(),
			getHeight(),  getBackground().darker(), true));
